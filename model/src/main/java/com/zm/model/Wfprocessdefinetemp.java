...
@TableName("wfprocessdefinetemp")
public class Wfprocessdefinetemp extends Model<Wfprocessdefinetemp> {

    private static final long serialVersionUID = 1L;

    @TableId("TEMPPROCESSDEFID")
    private BigDecimal tempprocessdefid;
